    ...
    messages: [
      ...
      },
      {
        ...
        content: [
          {
            type: "text",
            text: "This is an image of a Fire Tag, please analyze the tag and output the values for the following properties to JSON: nameOfTagIssuer, customerName, address, location, serial, rating, type, and lastTestDate. If the photo does not have a fire tag in it, then say `No fire tag`, if there is no value for a property, then return an empty string for that property.",
          },
          {
            type: "image_url",
            image_url: {
